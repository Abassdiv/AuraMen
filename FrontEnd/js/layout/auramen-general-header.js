 (function () {
    ...
    document.addEventListener('click', (e) => {
      if (!e.target.closest('#productsMenuBtn') && !e.target.closest('#productsMenu')) toggleProductsMenu(false);
      if (!e.target.closest('#searchTrigger') && !e.target.closest('#searchPanel')) toggleSearch(false);
    });
    document.addEventListener('keydown', (e) => {
      if (e.key === 'Escape') { toggleProductsMenu(false); toggleSearch(false); }
    });
